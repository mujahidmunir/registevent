...
return [
    ...
    */
    ...
    'password_reset_url' => 'auth/forgot',
    'password_email_url' => 'auth/reset',
    'profile_url' => false,
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Surat Kuasa',
            'url' => '/dashboard/download/surat-kuasa.pdf',
        ...
        [
            'text' => 'Manual Validasi',
            'url' => 'dashboard/validator',
            'icon' => 'fa fa-edit',
            'can' => 'admin'
        ],
    ],
        ...
        'DatatablesPlugins' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.datatables.net/buttons/2.2.3/js/buttons.html5.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
